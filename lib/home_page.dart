...
Future<MetricsData> getMetricsData(String phoneNumber) async {
  ...
  final String apiUrl = "https://nearlikes.com/v1/api/client/metrics";
...
class _HomePageState extends State<HomePage> {
  ...
  Future<GetCampaigns> getAvailableCampaigns(
    ...
    print("data..");
    final String apiUrl =
     //   "https://nearlikes.com/v1/api/campaign/get/campaigns";
  ...
  void initState() {
   ...
   // _campaignController = new StreamController();
    _metricsDataController = new StreamController();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: SafeArea(
          child: Scaffold(
            body: _getCustomer==null?Center(
                child: CircularProgressIndicator(color: kPrimaryColor,)):RefreshIndicator(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    if(_getCustomer.customer.status=='normal') Text('',
                                        style: GoogleFonts.montserrat(
                                          fontSize: 11,
                                          fontWeight: FontWeight.bold,
                                          color: Color(0xffB9B9B9),
                                        )),
                                    if(_getCustomer.customer.status=='bronze')Text('Bronze',
                                        style: GoogleFonts.montserrat(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                            color:Colors.brown
                                        )),
                                    if(_getCustomer.customer.status=='silver')Text('Silver',
                                        style: GoogleFonts.montserrat(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                            color:Colors.black45
                                        )),
                                    if(_getCustomer.customer.status=='gold')Text('Gold',
                                        style: GoogleFonts.montserrat(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                            color:Colors.amber
                        ...
                        child: StreamBuilder(
                          ...
                          //     followers: 500, location: "kolkata", age: 40),
                            ...
                            builder: (context, AsyncSnapshot snapshot) {
                              ...
                              print(snapshot.data);
                              return _getCampaigns.campaigns.length == 0
                                  ? Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: GestureDetector(
                                                  onTap: () {
                                                    ...
                                                    //     context,
                                                    //     MaterialPageRoute(
                                                    //         builder: (context) =>BrandDetails(campaign: _getCampaigns.campaigns[index],)));

                                                    if(_getCustomer.customer.status=='normal'){
                                                      showDialog(context: context,
                                                          builder: (BuildContext context){
                                                            return AlertDialog(
                                                              ...
                                                              content: Text("Please link with your Instagram account to start sharing brands",
                                                                style: GoogleFonts.montserrat(
                                                                    fontSize: 16,
                                                                    fontWeight: FontWeight.w400,
                                                                    color: Colors.black
                                                        ...
                                                        decoration: BoxDecoration(
                                                            image: DecorationImage(
                                                              // image: AssetImage('assets/scratch_card.png'),
                                                                image: NetworkImage('${_getCampaigns.campaigns[0].logo}'),
                                                                fit: BoxFit.cover),
                                                            ...
                                                            Center(
                                                              ...
                                                              Padding(
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      "${_getCampaigns.campaigns[0].brand}",
      ...
      child: FlipCard(
        ...
        front: Container(
          decoration: BoxDecoration(
            ...
            color: (!isDataNotPresent && _getMetricsData != null) ?kPrimaryPink:Colors.grey,
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              ...
              SizedBox(
                width: size.width * 0.25,
                child: Center( child: Center(child: Text( titles[index],
                  style: GoogleFonts.montserrat(
                  color: Colors.white,
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
        ...
        back: Container(
          ...
          child: Center(child: Text(((!isDataNotPresent && _getMetricsData != null) ? _getMetricsData.data[index].values.first.value.toString() : "0"),style: GoogleFonts.montserrat(
            color: Colors.white,
            fontSize: 21,
            fontWeight: FontWeight.bold,
          ))),
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: (!isDataNotPresent && _getMetricsData != null) ?Colors.redAccent:Colors.grey
        ),
        child: Padding(
          ...
          child: Center(
            child: Row(
              ...
              //  SizedBox(width: 20,),
                ...
                SizedBox(width: 20,),
                Center(child: Text("Analytics Total",
                  style: GoogleFonts.montserrat(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                ...
                Spacer(flex: 4,),
               Center(child:  Text(((!isDataNotPresent && _getMetricsData != null) ? value : "0"),style: GoogleFonts.montserrat(
                 fontSize: 21,
                 fontWeight: FontWeight.bold,
                 color: Colors.white,
               ),),),
