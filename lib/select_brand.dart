...
class _SelectBrandState extends State<SelectBrand> {
  ...
  getStatus() async {
    ...
    print(
        'SelectBrand ---> This function to check user login status! $phonenumber');
    var body = {
      "phone": phonenumber,
    };
                                              ...
                                              builder: (context) =>
                                                  BrandStories(
                                                    ...
                                                    id: _getCampaigns
                                                        .campaigns[index]
                                                        .ownerId,
                                                    campaignId: _getCampaigns
                                                        .campaigns[index].id,
                                                    brandMoto: _getCampaigns
                                                        .campaigns[index].text,
                                                    brandTag: _getCampaigns
                                                        .campaigns[index]
                                                        .username,
                                                  )));
                                    },
