...
class LinkUPI extends StatefulWidget {
  ...
  const LinkUPI({Key key, this.phoneNumber, this.cashbackId}) : super(key: key);
...
Future<String> updateUPI({String id, String upi, String email}) async {
  ...
  if (response.statusCode == 200) {
    ...
    text =
        "The UPI provided is already linked with another NearLikes account, Please provide another UPI";
    ...
    return Scaffold(
      ...
      child: Stack(
        children: [
          Padding(
            padding:
                EdgeInsets.symmetric(horizontal: 40, vertical: height * 0.1),
            child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: (val) =>
                              val.isEmpty ? 'The field cannot be empty' : null,
                          onSaved: (val) {
                            upi = val;
                          },
                        ),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: (val) => EmailValidator.validate(val) ==
                                  false
                              ? 'Enter valid email ID(check for unwanted spaces)'
                              : null,
                          onSaved: (val) {
                            email = val;
                          },
                              ...
                              if (_formKey.currentState.validate()) {
                                ...
                                if (response == true) {
                                  ...
                                  if (text == 'Successfully Updated!') {
                                    int response = await cashbackScratched(
                                        widget.cashbackId);
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  gradient: LinearGradient(
                                    ...
                                    colors: [
                                      UPI ? kLightGrey : kSecondaryColor,
                                      UPI ? kLightGrey : kPrimaryColor,
                                    ],
                                  )),
                              child: Center(
