...
class _NotificationPageState extends State<NotificationPage> {
  ...
  void initState() {
    ...
    _customerController = new StreamController();
              ...
              StreamBuilder(
                  ...
                  builder: (context, AsyncSnapshot snapshot) {
                    ...
                    return _getCustomer.customer.cashback.length == 0 &&
                        _getCustomer.customer.coupons.length == 0
                        ? Padding(
                      ...
                      children: [
                        ...
                        Container(
                          child: _getCustomer.customer.cashback.length !=
                              0
                              ? ListView.builder(
                            reverse: true,
                            shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext ctx, index) {
                              int timestamp = _getCustomer
                                  .customer.cashback[index].createdAt;
                              var date = DateTime
                        ...
                        Container(
                          child: _getCustomer.customer.coupons.length != 0
                              ? ListView.builder(
                              reverse: true,
                              shrinkWrap: true,
                              physics: NeverScrollableScrollPhysics(),
                              ...
                              itemBuilder: (BuildContext ctx, index) {
                                int timestamp = _getCustomer
                                    .customer.coupons[index].createdAt;
                                var date = DateTime
                                    .fromMillisecondsSinceEpoch(
                                    timestamp * 1000);
                                var day = DateFormat('dd/MM/yy')
