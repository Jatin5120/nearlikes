...
class ChooseAccount extends StatefulWidget {
  final String igUserId, accessToken;
  final Map<String, dynamic> igDetails;
  final bool value;
  const ChooseAccount({
    Key key,
    this.igDetails,
...
class _ChooseAccountState extends State<ChooseAccount> {
  ...
  uploadUserData(String accessToken, int follwerCount) async {
    ...
    var body = {
      "user": widget.igDetails['username'],
      //"name": "${widget.name}",
      //"age": widget.age,
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        if (followersCount > 1000) {
                          ...
                          var response = await uploadUserData(
                              widget.accessToken, followersCount);
                          ...
                          if (response == true) {
                            ...
                            setState(() {
                              error =
                                  'The selected Instagram account is already with another account';
                              loading = false;
                            });
                          }
